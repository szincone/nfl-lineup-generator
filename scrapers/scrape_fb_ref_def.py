#! python
# scrape_fb_ref_def.py - scrapes pro-football reference and turns into a pandas dataframe
import requests
import bs4
import pandas as pd
import os
...
# url we're scraping
url_data = os.getenv("defense_url")
...
# getting data_rows (necessary for getting player data)
